...
function connect(event) {
    ...
    idform = document.querySelector('#idform').value.trim();
    ...
    if(username) {
        ...
        convertionName = convertionName+idform;
        topicName = topicName+idform;
        convertionAdd = convertionAdd+idform;
...
sendMessage.addEventListener('submit', chatMessage, true)